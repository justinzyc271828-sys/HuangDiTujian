...
一行速记：`武功15 · 文治35 · 韬略30 · 国祚20 · 后效78 · 月旦78`

## 2. 画面设计（中文说明 · 给美术/你自己）

| 项 | 内容 |
|----|------|
| 一句话场景 | 金陵夜雨，词人帝王倚窗；城破火光映水，墨迹在雨中化开。 |
| 代表事件 | 975城破 / 江南残梦 |
| 关键道具 | 雨窗、词稿（勿显字）、秦淮、火光水影 |
| 气质色调 | 水墨湿冷 |
| 史料钩 | `content/sources/n-tang-houzhu/` · 分镜 `content/video/video-01/分镜/n-tang-houzhu.md` |
