...
一行速记：`武功85 · 文治95 · 韬略88 · 国祚55 · 后效91 · 月旦88`

## 2. 画面设计（中文说明 · 给美术/你自己）

| 项 | 内容 |
|----|------|
| 一句话场景 | 长江上南征舰影，建康降帜；身后大兴城网格如制度蓝图。 |
| 代表事件 | 开皇灭陈 / 混一戎夏 |
| 关键道具 | 战船、建康、大兴规划网格、皂衣帝 |
| 气质色调 | 清俭冷色，制度感 |
| 史料钩 | `content/sources/sui-wen/` · 分镜 `content/video/video-01/分镜/sui-wen.md` |
