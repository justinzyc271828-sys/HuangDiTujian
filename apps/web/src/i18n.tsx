...
export const STR: Record<string, { zh: string; en: string }> = {
  ...
  "gallery.sub": {
    zh: "奏折三栏专页 · 点卡即入（专页草稿 {draft} · 灰卡 stub {stub} · 准 {quasi}）",
    en: "Three-column memorial pages · click a card to enter (drafts {draft} · stubs {stub} · quasi {quasi})",
  },
  "gallery.searchPh": {
    zh: "搜索姓名 / 朝代 / id…",
